// Modified version of Unity built-in shader source for VRCLightmapMixer.
// Original source: Unity built-in shader source. Copyright (c) 2016 Unity Technologies. MIT license (see license.txt)
...
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
UNITY_DECLARE_TEX2D(_LightMapA);
UNITY_DECLARE_TEX2D(_LightMapB);
float _UdonMultiLightmapGlobalMixUse, _UdonMultiLightmapGlobalMixA, _UdonMultiLightmapGlobalMixB;

inline half3 ChangeLightmapTex(half3 i, float2 lightmapUV) {
    half3 bakedColorA = DecodeLightmap(UNITY_SAMPLE_TEX2D(_LightMapA, lightmapUV));
    half3 bakedColorB = DecodeLightmap(UNITY_SAMPLE_TEX2D(_LightMapB, lightmapUV));
    half3 bakedColor = (bakedColorA * _UdonMultiLightmapGlobalMixA + bakedColorB * _UdonMultiLightmapGlobalMixB);

    return lerp(i, bakedColor, _UdonMultiLightmapGlobalMixUse);
}
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
